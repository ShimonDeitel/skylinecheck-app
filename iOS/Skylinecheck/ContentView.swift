...
struct ContentView: View {
    ...
    @State private var editingEntry: SkylinecheckEntry?
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle("Skyline Checklist")
            .toolbar {
    ...
    var body: some View {
        NavigationStack {
            Form {
                ...
                if entry != nil {
                    Section {
                        Button("Delete Landmark", role: .destructive) {
            ...
            .navigationTitle(entry == nil ? "Add Landmark" : "Edit Landmark")
            .toolbar {
