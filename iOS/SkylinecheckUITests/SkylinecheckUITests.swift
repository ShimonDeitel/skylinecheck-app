...
final class SkylinecheckUITests: XCTestCase {
    ...
    func testFreeLimitTriggersPaywall() {
        ...
        XCTAssertTrue(app.buttons["purchaseButton"].waitForExistence(timeout: 3) || app.staticTexts["Skyline Checklist Pro"].waitForExistence(timeout: 3))
    }
